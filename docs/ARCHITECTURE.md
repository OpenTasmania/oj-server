...
The OpenJourney Server implements a pluggable, microservices-based architecture for processing static transit data. The
system is designed around an ETL pipeline to convert transit data (GTFS, NeTEx) into a canonical database schema
...
1. **Additional Data Sources**: NeTEx, TransXChange processors
