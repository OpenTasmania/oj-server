...
VM_IP_OR_DOMAIN_DEFAULT = "example.com" # Should be a real FQDN for Certbot to work
...
PYTHON_SYSTEM_PACKAGES = [ # System-level Python packages
    ...
    "python3-pandas", "python3-psycopg2", "python3-psycopg", "python3-pydantic"
]
POSTGRES_PACKAGES = [
...
LOG_PREFIX: str = LOG_PREFIX_DEFAULT # This will be set by main.py from args for the logger format
