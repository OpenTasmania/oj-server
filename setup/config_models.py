...
PGPASSWORD_DEFAULT: str = "yourStrongPasswordHere"  # Mark as sensitive
...
PG_TILESERV_CONFIG_DIR_DEFAULT = "/etc/pg_tileserv"  # Static path for dir
PG_TILESERV_CONFIG_FILENAME_DEFAULT = "config.toml"  # Static filename
