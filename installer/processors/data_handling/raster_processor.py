...
from common.system_utils import calculate_threads
...
def raster_tile_prerender(
    ...
    Returns:
        bool: True if the tile pre-rendering tasks were successfully queued, False otherwise.
    ...
    num_threads_str = calculate_threads(app_settings, logger_to_use)
